...
def interpret_sugar(sugar):
    if sugar < 70:
        return 'น้ำตาลต่ำ', 'ควรปรึกษาแพทย์เรื่องภาวะน้ำตาลต่ำ และพกของหวานติดตัว'
    elif sugar < 99:
        return 'ปกติ', 'ระดับน้ำตาลปกติ ควรรักษาไว้โดยลดหวานและออกกำลังกายสม่ำเสมอ'
    elif sugar < 125:
        return 'ระดับน้ำตาลสูง', 'ควรควบคุมอาหาร หลีกเลี่ยงของหวาน แป้งขัดขาว และออกกำลังกายอย่างสม่ำเสมอ'
    else:
        return 'เบาหวาน', 'ควรพบแพทย์เพื่อตรวจยืนยัน และรับคำแนะนำเรื่องโภชนาการและยา'
