...
def interpret_bmi(bmi):
    if bmi < 18.5:
        return 'ผอม', 'ควรรับประทานอาหารให้ครบ 5 หมู่ และตรวจสุขภาพเป็นระยะ'
    elif bmi < 23:
        return 'ปกติ', 'น้ำหนักเหมาะสม รักษาน้ำหนักและออกกำลังกายสม่ำเสมอ'
    elif bmi < 25:
        return 'ท้วม/น้ำหนักเกิน', 'ควรควบคุมอาหารและเริ่มออกกำลังกาย'
    elif bmi < 30:
        return 'อ้วนระดับ 1', 'ควรลดน้ำหนักด้วยการปรับพฤติกรรมและควบคุมอาหาร'
    else:
        return 'อ้วนระดับ 2', 'น้ำหนักเกินมาก เสี่ยงต่อโรคเรื้อรัง ควรพบแพทย์เพื่อคำแนะนำ'
...
def interpret_sugar(sugar):
    if sugar < 70:
        ...
        return 'เบาหวาน', 'ควรพบแพทย์เพื่อตรวจวินิจฉัยและรับคำแนะนำ'

def interpret_bp(sys, dia):
    if sys < 120 and dia < 80:
        return 'ความดันปกติ', ''
    elif 120 <= sys <= 139 or 80 <= dia <= 89:
        return 'ความดันเริ่มสูง', 'ควรลดเค็ม ออกกำลังกาย และติดตามความดันเสมอ'
    else:
...
def interpret_waist(waist, gender):
    if (gender == 'male' and waist > 90) or (gender == 'female' and waist > 80):
        advice = "คุณมีรอบเอวสูง ซึ่งอาจเสี่ยงต่อโรคเบาหวาน ความดัน ไขมันในเลือด โรคหัวใจ\nควรลดน้ำตาล ออกกำลังกายสม่ำเสมอ และควบคุมน้ำหนัก"
